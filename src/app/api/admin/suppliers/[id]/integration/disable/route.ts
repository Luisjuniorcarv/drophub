...
/**
 * POST /api/admin/suppliers/:id/integration/disable
...
export async function POST(req: NextRequest, { params }: Params) {
  try {
    ...
    const integration = await SupplierIntegrationManager.disableIntegration(id);
    ...
    console.error("[API_SUPPLIER_INTEGRATION_DISABLE_ERROR]", error);
    return NextResponse.json({ error: "Erro ao desativar integração do fornecedor." }, { status: 500 });
  }
}
