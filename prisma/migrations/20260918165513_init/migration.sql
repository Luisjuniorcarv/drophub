...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('AWAITING_PAYMENT', 'PAID', 'PROCESSING', 'AWAITING_SUPPLIER', 'SENT_TO_SUPPLIER', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('PIX', 'CREDIT_CARD', 'BOLETO', 'TEST_MODE');

-- CreateEnum
CREATE TYPE "ExpenseCategory" AS ENUM ('MARKETING', 'TOOLS', 'DOMAIN', 'LOGISTICS', 'TAXES', 'REFUND', 'OTHER');
...
CREATE TABLE "Order" (
    ...
    "totalCostAmount" DECIMAL(10,2) NOT NULL,
...
CREATE TABLE "Payment" (
    "id" TEXT NOT NULL,
    "orderId" TEXT NOT NULL,
    "gateway" TEXT NOT NULL DEFAULT 'TEST_GATEWAY',
    "method" "PaymentMethod" NOT NULL DEFAULT 'TEST_MODE',
...
-- CreateIndex
CREATE INDEX "Tracking_timestamp_idx" ON "Tracking"("timestamp");
...
-- CreateIndex
CREATE INDEX "AutomationLog_source_idx" ON "AutomationLog"("source");

-- CreateIndex
CREATE INDEX "AutomationLog_eventType_idx" ON "AutomationLog"("eventType");
...
-- CreateIndex
CREATE INDEX "AiGeneration_promptType_idx" ON "AiGeneration"("promptType");
